        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        newHash = _a.sent();
                        return [4 /*yield*/, this._pool.query(this._queries.update, [
                    ...
                    case 2:
                        result = _a.sent();
                        chai_1.expect(result.rowCount, errors_module_1.default.cannotUpdate.message).to.equal(1);
                        return [2 /*return*/, true];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        chai_1.expect(result.rowCount, errors_module_1.default.cannotDelete.message).to.equal(1);
                        return [2 /*return*/, true];
                }
            });
        });
